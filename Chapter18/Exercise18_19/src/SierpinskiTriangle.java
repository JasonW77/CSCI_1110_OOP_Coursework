...
import javafx.stage.Stage;
	...
	*/
		...
		Button btDN = new Button("-");
		
		btUP.setOnAction(e -> trianglePane.orderUp());
		btDN.setOnAction(e -> trianglePane.orderDn());
		
	    hBox.getChildren().addAll(btUP, btDN);
